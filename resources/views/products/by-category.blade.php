        ...
        <div class="products-columns">
            @foreach($last_products as $product)
                <div class="products-columns__item">
                    ...
                    <div class="products-columns__item__thumbnail"><a href="#" class="products-columns__item__thumbnail__link"><img src="{{asset($product->photo_path)}}" alt="Preview-image" class="products-columns__item__thumbnail__img"></a></div>
