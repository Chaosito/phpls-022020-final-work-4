    ...
    <header class="main-header">
        ...
        <div class="header-container">
            ...
            @else
                ...
                @endphp
                <div class="authorization-block">
                    <a href="{{ route('index') }}" class="authorization-block__link" style="{{$adminStyle}}">{{ Auth::user()->name }}</a><a href="{{ route('logout') }}" class="authorization-block__link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('auth.Logout') }}</a>
                </div>
